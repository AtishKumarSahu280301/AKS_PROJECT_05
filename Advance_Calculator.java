...
public class Advance_Calculator {
	...
	private void initialize() {
		...
		calculatorframe.setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\Atish kumar sahu\\eclipse-workspace\\Advance Calculator Project\\src\\calculator.png"));
		calculatorframe.getContentPane().setBackground(new Color(105, 105, 105));
		calculatorframe.setTitle("Advance Calculator(Atish Kumar Sahu)");
